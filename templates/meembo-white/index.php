	...
	<div id="header">
		...
		<div id="logo">
			...
			<?php if ($logo && $logoimage == 1): ?>
				<a href="../"><img src="<?php echo htmlspecialchars($logo); ?>"  alt="<?php echo $sitename; ?>" /></a>
			<?php endif; ?>
			<?php if (!$logo || $logoimage == 0): ?>

				<?php if ($sitetitle): ?>
					<a href="../"><?php echo htmlspecialchars($sitetitle); ?></a><br/>
				<?php endif; ?>

				<?php if ($sitedescription): ?>
					<a href="../"><?php echo htmlspecialchars($sitedescription); ?></div>
				<?php endif; ?>
...
<!-- Page End -->
	...
	<div id="copyright">&copy;<?php echo date('Y'); ?> <?php echo $sitename; ?></div>
