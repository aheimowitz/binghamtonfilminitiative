...
class KunenaControllerTopic extends KunenaController {
	...
	public function post() {
		...
		$fields = array (
			...
			'positions' => JRequest::getVar ( 'positions', null, 'POST', 'string', JREQUEST_ALLOWRAW ),
		...
		if (! $success) {
			...
			$db = JFactory::getDBO();
			$position = (string)$fields['positions'];
			$db->setQuery ( "UPDATE #__kunena_messages SET positions='$position' WHERE id=$message->id" );
			$count = $db->loadResult ();
		}
