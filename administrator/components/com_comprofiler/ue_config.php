...
$ueConfig['reg_pend_appr_sub']='BFI Email Eonfirmation';
...
[DETAILS]
Kind Regards,
Binghamton Film Initiative Team';
$ueConfig['reg_welcome_sub']='New User Details';
$ueConfig['reg_welcome_msg']='Welcome [NAME],
Your email has been confirmed and you are now ready to start using BFI
Your account with the following details:
[DETAILS]
has been activated.
Head on over to www.binghamtonfilminitiative.com and login to get started!
...
$ueConfig['reg_first_visit_url']='index.php?option=com_content&view=article&id=8';
